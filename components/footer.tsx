...
const footer = () => {
  ...
  <div className="max-w-screen-xl mx-auto text-center">
      ...
      <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2021-2022 <a href="#" className="hover:underline">Champion Cleaning</a>. All Rights Reserved.</span>
  </div>
      </footer>
    </div>
  );
