  ...
  return (
    ...
    <footer className="bg-gray-700 ">
        <div className="max-w-screen-xl pt-2 mx-auto text-center">
            <a href="#" className="flex items-center justify-center text-2xl font-semibold text-white ">
        ...
        <ul className="flex flex-wrap items-center justify-center mt-2 mb-2 text-white ">
          <li>
        ...
        <span className="text-sm text-white sm:text-center">© 2023-2024 <a href="/" className="hover:underline">Champion Cleaning</a>. All Rights Reserved.</span>
        </div>
    </footer>
    </>
  );
