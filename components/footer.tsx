...
const footer = () => {
  return (
    ...
    <footer className="bg-black ">
        ...
        <ul className="flex flex-wrap items-center justify-center mt-2 mb-2 text-yellow-100 ">
          <li>
        ...
        <span className="text-sm text-yellow-100 sm:text-center">© 2023-2024 <a href="/" className="hover:underline">Champion Cleaning</a>. All Rights Reserved.</span>
        </div>
    </footer>
    </>
  );
