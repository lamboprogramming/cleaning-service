  ...
  return (
    <> 
      ...
      <div className="p-2 bg-white rounded-lg shadow-md ">
        <Image src={c1} alt="Service 1" className="object-cover w-full h-40 mb-4 rounded-lg" />
      ...
      {/* Card 2 */}
      <div className="p-2 bg-white rounded-lg shadow-md ">
        <Image src={c2} alt="Service 2" className="object-cover w-full h-40 mb-4 rounded-lg" />
        ...
        {/* Card 3 */}
      <div className="p-2 bg-white rounded-lg shadow-md ">
        <Image src={c4} alt="Service 3" className="object-cover w-full h-40 mb-4 rounded-lg" />
        ...
        <div className="grid items-center gap-4 p-4 md:grid-cols-3">
          ...
          {/* Card 4 */}
          <div className="p-2 bg-white rounded-lg shadow-md ">
          <Image src={c5} alt="Service 4" className="object-cover w-full h-40 mb-4 rounded-lg" />
          ...
          <Link legacyBehavior href="/services/service4">
            ...
            {/* Card 5 */}
        <div className="p-2 bg-white rounded-lg shadow-md ">
          <Image src={c6} alt="Service 5" className="object-cover w-full h-40 mb-4 rounded-lg" />
          ...
          <Link legacyBehavior href="/services/service5">
            ...
            {/* Card 6 */}
          <div className="p-2 bg-white rounded-lg shadow-md ">
            <Image src={c3} alt="Service 6" className="object-cover w-full h-40 mb-4 rounded-lg" />
