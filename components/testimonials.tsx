  ...
  <div className='mb-1 '>
    ...
    <figcaption className="flex items-center mt-4 space-x-3">
        ...
        <div className="flex items-center divide-x-2 divide-gray-300">
            <cite className='pr-3 text-sm text-gray-500'>
            <BsListCheck className="text-3xl" />
            </cite>
            <cite className="pl-3 font-sans text-sm leading-6 tracking-wider text-gray-500 ">3 bedrooms • 3 bathrooms • Standard cleaning • Pets in home • Every week</cite>
        </div>
    </figcaption>
</figure>
  ...
  <div className='mb-1 '>
    ...
    <figcaption className="flex items-center mt-4 space-x-3">
        ...
        <cite className='pr-3 text-sm text-gray-500'>
            ...
            <cite className="pl-3 font-sans text-sm leading-6 tracking-wider text-gray-500 ">2 bedrooms • 2 bathrooms • Standard cleaning • Pets in home • Once a month</cite>
        </div>
    </figcaption>
</figure>
  ...
  <div className='mb-1 '>
    ...
    <figcaption className="flex items-center mt-4 space-x-3">
        ...
        <cite className='pr-3 text-sm text-gray-500'>
            ...
            <cite className="pl-3 font-sans text-sm leading-6 tracking-wider text-gray-500 ">2 bedrooms • 1 bathroom • Move out cleaning • Fridge cleaning • Oven cleaning • Pets in home • Just once</cite>
        </div>
    </figcaption>
</figure>
  ...
  <div className='mb-1 '>
    ...
    <figcaption className="flex items-center mt-4 space-x-3">
        ...
        <div className="flex items-center divide-x-2 divide-gray-300">
            ...
            <cite className="pl-3 font-sans text-sm leading-6 tracking-wider text-gray-500 ">2 bedrooms • 2 bathrooms • Standard cleaning • No pets in home • Every 2 weeks</cite>
        </div>
    </figcaption>
</figure>
  ...
  <div className='mb-1 '>
    ...
    <figcaption className="flex items-center mt-4 space-x-3">
        ...
        <div className="flex items-center divide-x-2 divide-gray-300">
            ...
            <cite className="pl-3 font-sans text-sm leading-6 tracking-wider text-gray-500 "> 3 bedrooms • 2 bathrooms • Deep cleaning • Fridge cleaning • Window cleaning (interior) • Oven cleaning • Laundry • No pets in home • Just once</cite>
        </div>
    </figcaption>
</figure>
  ...
  <div className='mb-1 '>
    ...
    <figcaption className="flex items-center mt-4 space-x-3">
        ...
        <div className="flex items-center divide-x-2 divide-gray-300">
            ...
            <cite className="pl-3 font-sans text-sm leading-6 tracking-wider text-gray-500 ">1 bedroom • 1 bathroom • Deep cleaning • Oven cleaning • Window cleaning (interior) • Fridge cleaning • Pets in home • Just once</cite>
        </div>
    </figcaption>
</figure>
  ...
  <div className='mb-1 '>
    ...
    <figcaption className="flex items-center mt-4 space-x-3">
        ...
        <div className="flex items-center divide-x-2 divide-gray-300">
            ...
            <cite className="pl-3 font-sans text-sm leading-6 tracking-wider text-gray-500 ">2 bedrooms • 1 bathroom • Standard cleaning • Laundry • Window cleaning (interior) • Fridge cleaning • Pets in home • Once a month</cite>
        </div>
    </figcaption>
</figure>
  ...
  <div className='mb-1 '>
    ...
    <figcaption className="flex items-center mt-4 space-x-3">
        ...
        <div className="flex items-center divide-x-2 divide-gray-300">
            ...
            <cite className="pl-3 font-sans text-sm leading-6 tracking-wider text-gray-500 ">1 bedroom • 1 bathroom • Move out cleaning • Window cleaning (interior) • Fridge cleaning • Pets in home • Just once</cite>
        </div>
    </figcaption>
</figure>
  {/* Ninth Testimonial */}
  ...
  <div className='mb-1 '>
    ...
    <figcaption className="flex items-center mt-4 space-x-3">
        ...
        <cite className='pr-3 text-sm text-gray-500'>
            ...
            <cite className="pl-3 font-sans text-sm leading-6 tracking-wider text-gray-500 ">2 bedrooms • 3 bathrooms • Move out cleaning • Fridge cleaning • Oven cleaning • Window cleaning (interior) • Pets in home • Just once</cite>
        </div>
    </figcaption>
</figure>
